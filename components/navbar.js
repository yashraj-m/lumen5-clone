function navbar(){
    ...
    <ul class="nav-links" id="menu">
        ...
        <li><button type="button" class="btn btn-outline-primary" style="border-radius: 16px" >Login</button></li>
        <li><button type="button" class="btn btn-primary" style="border-radius: 16px" >Signup</button></li>
    </ul>
